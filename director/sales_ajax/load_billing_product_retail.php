...
<div class="card-body table-responsive p-0">
    <table class="table table-hover">
        ...
        <tr>
            <td colspan="3"></td>
            <td>Old Balance</td>
            <td style="width:15%;text-align:center"><input class="form-control" style="width:100%;box-sizing:border-box;" type="number" name="balance" id="balance" value="<?php echo $total ?>" readonly></td>
            <td>Balance</td>
