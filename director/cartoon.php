                ...
                <div class="col-sm-8">
                  <div class="row">
                    ...
                    <div class="col-md 9">
                      ...
                      <input list="list-customers" class="form-control" id="customer_name" name="customer_name" value="<?php $ctr->oldValue("customer_name") ?>" autocomplete="off">
                      <datalist class="datalist" id="list-customers" autocomplete="off">
                        <?php
  ...
  function selectManufacturer(value1, value2, value3) {
    $(document).ready(function() {
      ...
      if (manufacturer && model && productname != "") {
        $.ajax({
          url: "sales_ajax/load_cprice.php",
          method: "POST",
          data: {
