 ...
 <table class="table table-hover">
    ...
    <capital>
        <tr>
            ...
            <td class="d-print-none text-center"><a href="search_record_details.php?invoice_no=<?php echo $row['invoice_no'] ?>&customer_name=<?php echo $row['customer_name'] ?>&address=<?php echo $row['address'] ?>"><i class="fa fa-eye"></i></a>
                                                </td>
        </tr>
        </capital>
        <?php }
