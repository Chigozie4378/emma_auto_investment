...
<script>
    function availableName(name){
        ...
        xhttp.open("GET", "ajax/load_return_history_name.php?name="+name, true);
        xhttp.send();
    }
    function availableAddress(address,name){
        ...
        xhttp.open("GET", "ajax/load_return_history_address.php?address="+address+"&name="+name, true);
        xhttp.send();
    }
    function availableInvoiceNo(invoice_no){
        ...
        xhttp.open("GET", "ajax/load_return_history_invoice.php?invoice_no="+invoice_no, true);
        xhttp.send();
    }
</script>
<?php
