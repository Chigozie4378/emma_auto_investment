...
<script>
  function customerName(name) {
    ...
    fetch("/emma_auto_investment/ajax/admin/sales_history/load_sales_name.php?name=" + encodeURIComponent(name))
      .then(res => res.text())
      .then(html => {
  ...
  function customerAddress(address, name) {
    ...
    fetch("/emma_auto_investment/ajax/admin/sales_history/load_sales_address.php?address=" + encodeURIComponent(address) + "&name=" + encodeURIComponent(name))
      .then(res => res.text())
      .then(html => {
        document.getElementById("table").innerHTML = html;
        window.bindRowClicks();
  ...
  function staffName(staffname) {
    ...
    fetch("/emma_auto_investment/ajax/admin/sales_history/load_sales_staffname.php?staffname=" + encodeURIComponent(staffname))
      .then(res => res.text())
      .then(html => {
