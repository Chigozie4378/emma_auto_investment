...
class Model extends DB
{
    ...
    //     return $select;
    // }
    public function addSales($customer_name, $address, $invoice_no, $bill_type, $total, $cash, $transfer, $deposit, $balance, $date)
    {
        mysqli_query($this->connect(), "INSERT INTO sales VALUES(null,'$customer_name', '$address', '$invoice_no', '$bill_type', '$total','$cash','$transfer','$deposit', '$balance',  '$date')");
    }
    public function addSalesDetails($customer_name, $address, $invoice_no, $productname_session, $model_session, $manufacturer_session, $quantity_session, $price_session, $amount, $date)
    {
        mysqli_query($this->connect(), "INSERT INTO sales_details(customer_name,address,invoice_no,product_name,model,manufacturer,quantity,price,amount,date) VALUES('$customer_name', '$address', '$invoice_no', '$productname_session', '$model_session','$manufacturer_session', '$quantity_session',  '$price_session','$amount','$date')");
    }
