            ...
            <div class="card-body bg-primary rounded">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="row">
                    ...
                    <div class="col-md 9">
                      ...
                      <input list="list-customers" class="form-control" id="customer_name" onclick="select()" name="customer_name" value="Sir">
                ...
                <div class="col-sm-8">
                  ...
                  <input list="list-address" class="form-control" id="address" name="address" onclick="select()" value="Address">
...
<script>
  ...
  function loadBillingProduct() {
    ...
    xhttp.open("POST", "ajax/load_bill_product.php", true);
    xhttp.send();
  }
...
xhttp.open("GET", "ajax/load_deposit.php?cash=" + cash + "&pos=" + pos + "&transfer=" + transfer + "&total=" + total + "&old_deposit=" + old_deposit + "&transport=" + transport + "&charges=" + charges, true);
xhttp.send();
...
xhttp.open("GET", "ajax/load_deposit.php?pos=" + pos + "&cash=" + cash + "&transfer=" + transfer + "&total=" + total + "&old_deposit=" + old_deposit + "&transport=" + transport + "&charges=" + charges, true);
xhttp.send();
...
xhttp.open("GET", "ajax/load_deposit.php?transport=" + transport + "&pos=" + pos + "&cash=" + cash + "&transfer=" + transfer + "&total=" + total + "&old_deposit=" + old_deposit + "&charges=" + charges, true);
xhttp.send();
...
xhttp.open("GET", "ajax/load_deposit.php?charges=" + charges + "&cash=" + cash + "&pos=" + pos + "&transfer=" + transfer + "&total=" + total + "&old_deposit=" + old_deposit + "&transport=" + transport, true);
xhttp.send();
}
...
function addTransport() {
  ...
  function updatePage() {
    ...
    xhttp.open("GET", "ajax/load_invoice_no.php", true);
    xhttp.send();
  }
