...
<script>
    function transferCalc(transfer, pos, cash) {
        ...
        xhttp.open("GET", "ajax/load_deposit2.php?cash=" + cash + "&pos=" + pos + "&transfer=" + transfer, true);
        xhttp.send();
    ...
    function posCalc(pos, transfer, cash) {
        ...
        xhttp.open("GET", "ajax/load_deposit2.php?pos=" + pos + "&cash=" + cash + "&transfer=" + transfer, true);
        xhttp.send();
