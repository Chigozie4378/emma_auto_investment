            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <div class="inner" style="text-align:center">
                        ...
                        <h3>
                            <?php echo number_format($count['countcustomers']); ?>
                        </h3>
                        <br>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    <div class="inner" style="text-align:center">
                        ...
                        ?>
                        <h3>#
                            <?php echo number_format($total['sumTotal']) ?>
                        </h3>
                        <br>
                        <p>Total Sales</p>
                    </div>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner" style="text-align:center">
                        ...
                        ?>
                        <h3>#
                            <?php echo number_format($sum_credit['credit']) ?>
                        </h3>

                        <p>Cash #
                            <?php echo number_format($sum_cash['cash']) ?> <br> Transfer #
                            <?php echo number_format($sum_transfer['transfer']) ?> POS # <?php echo number_format($sum_pos['pos']) ?>
                        </p>
                    </div>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    <div class="inner" style="text-align:center">
                        ...
                        ?>
                        <h3>#
                            <?php echo number_format($sum_debit['balance']) ?>
                        </h3>
                        <br>
                        <p>Total Debit</p>
