...
<body class="hold-transition login-page body">
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item"><a class="nav-link active" href="index.php">Staff</a></li>
    ...
    <li class="nav-item"><a class="nav-link" href="director_login.php">Director</a></li>
  </ul>
  <div class="card-body">
    <div class="tab-content" id="custom-tabs-one-tabContent">
      <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
        ...
        <div class="login-box">
          <div class="login-logo"><b>Staff Login</b></div>
          <div class="card">
