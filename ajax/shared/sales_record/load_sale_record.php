...
$sales_record_stat = $ctr->getSalesRecordStats($date);
?>
<table class="table table-hover">
    ...
    <tbody>
        <?php
        $select = $ctr->getSalesRecordsByDate($date);
        while ($row = mysqli_fetch_assoc($select)) { ?>
            <tr class="clickable-row" 
                ...
                <td style="text-transform:uppercase"><?= $row['customer_name'] ?></td>
                <td style="text-transform:uppercase"><?= $row['address'] ?></td>
                <td style="text-transform:uppercase"><?= $row['payment_type'] ?></td>
                <td style="text-transform:uppercase"><?= $row['customer_type'] ?></td>
                <td style="text-transform:uppercase"><?= $row['total'] ?></td>
                <td style="text-transform:uppercase"><?= $row['deposit'] ?></td>
                <td style="text-transform:uppercase"><?= $row['balance'] ?></td>
                <td style="text-transform:uppercase"><?= $row['staff_name'] ?></td>
                <td style="text-transform:uppercase"><?= $row['date'] ?></td>
            </tr>
        <?php }
        ?>
    </tbody>
