            ...
            <table class="table table-striped table-light table-bordered">
                ...
                <tr>
                    <form action="" method="post">
                        ...
                        <td> <button type="submit" onclick="updatePayment('<?php $ctr->viewSalesDetail('invoice_no'); ?>',getElementById('transfer1').value,getElementById('bank').value,'<?php $ctr->viewSalesDetail('deposit') ?>','<?php $ctr->viewSalesDetail('total') ?>','<?php echo $ctr->viewSalesDetail('customer_name'); ?>','<?php echo $ctr->viewSalesDetail('address'); ?>','<?php echo date('d-m-Y') ?>','<?php echo $_SESSION['managerfullname']; ?>',getElementById('cash1').value,'<?php echo $ctr->viewSalesDetail('customer_type'); ?>',getElementById('pos1').value)" type="submit" class=" btn btn-sm btn-info d-print-none">Change Payment</button></td>
                    </form>
                    <?php 
