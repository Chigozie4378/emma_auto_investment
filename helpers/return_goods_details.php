        ...
        <div class="row">
            <div class="col-4">
                <table class="table table-striped table-light table-bordered">
                    <tr class="odd gradeX">
                    <th>NAME:    </th>
                    <td><?php echo $return_goods_histories_ctr->viewReturnGoods("customer_name");?></td>
                    <th>ADDRESS:</th>
                    <td><?php echo  $return_goods_histories_ctr->viewReturnGoods("address");?></td>
                ...
                <tr class="odd gradeA">
                    <th>INVOICE NO:</th>
                    <td><?php echo $return_goods_histories_ctr->viewReturnGoods("invoice_no");?></td>
                    <th>PAYMENT TYPE:</th>
                    <td><?php echo $return_goods_histories_ctr->viewReturnGoods("payment_type");?></td>
                </tr>
                
                <tr class="even gradeA">
                    <th>DATE:</th>
                    <td><?php echo $return_goods_histories_ctr->viewReturnGoods("date");?></td>
                    <td colspan="2"></td>
                </tr>
        ...
        <div class="row">
            <div class="col-sm-12 fixTableHead">
                ...
                <h3 class="text-white"</h3>
                       <td style="font-weight: bold;"># <?php echo number_format($return_goods_histories_ctr->viewReturnGoods("total"));?></td>
                   </tr>
                </table>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="form-inline" style="float: right;">
                 ...
                 <input type="text" class="form-control" value= "<?php $return_goods_histories_ctr->viewReturnGoods("staff_name");?>">
