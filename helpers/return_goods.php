                    ...
                    <div class="card-body table-responsive p-0 fixTableHead">
                        <table class="table table-hover">
                            ...
                            <tbody id="table">
                                ...
                                $return_goods_histories = $return_goods_histories_ctr->paginateReturnAllGoods();
...
<script>
    function availableName(name) {
        ...
        fetch("/emma_auto_investment/ajax/shared/return_goods/load_return_goods_name.php?name=" + encodeURIComponent(name))
            .then(res => res.text())
            .then(html => {
    ...
    function availableAddress(address, name) {
        ...
        fetch("/emma_auto_investment/ajax/shared/return_goods/load_return_goods_address.php?address=" + encodeURIComponent(address) + "&name=" + encodeURIComponent(name))
            .then(res => res.text())
            .then(html => {
                document.getElementById("table").innerHTML = html;
                window.bindRowClicks();
    ...
    function availableInvoiceNo(invoice_no) {
        ...
        fetch("/emma_auto_investment/ajax/shared/return_goods/load_return_goods_invoice..php?invoice_no=" + encodeURIComponent(invoice_no))
            .then(res => res.text())
            .then(html => {
                document.getElementById("table").innerHTML = html;
                window.bindRowClicks();
